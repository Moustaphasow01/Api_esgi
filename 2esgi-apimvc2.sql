...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 30 mars 2023 à 09:59
...
INSERT INTO `user` (`idUser`, `firstname`, `lastname`, `birthday`, `email`) VALUES
(1, 'Jean', 'DUpond', NULL, 'jean.dupond@gmail.com');
COMMIT;
